...
@section('intro')
<div class="welcome" style="background-color: #ffffff; opacity:0.4;">
    <div class="card" >
        ...
        <div class="d-flex flex-wrap justify-content-evenly">
            ...
            <div class="card my-3" style="width: 350px;">
                <div class=" card-image-top image" style="height: 150px; width: auto;">
                    <img src="{{url('/images/hustleprime.gif')}}" class="project-active" style="height: 150px; width:100%; position:absolute;" alt="...">
                </div>
                <div class="card-body">
                ...
                <div class="card-bottom text-end pr-2 pb-2">
                    <svg xmlns='http://www.w3.org/2000/svg' class='' style="width: 20px;" fill="#6d6d6d" viewBox='0 0 512 512'>
                        <title>Sass</title>
            ...
            <div class="card my-3" style="width: 350px;">
                <div class=" card-image-top image" style="height: 150px; width: auto;">
                    <img src="{{url('/images/todolist.gif')}}" class="img-responsive project-active" style="height: 150px; width:100%; position:absolute;" alt="...">
                </div>
                <div class="card-body">
                ...
                <div class="card-bottom text-end pr-2 pb-2">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class='' style="width: 20px;" fill="#6d6d6d" viewBox="0 0 16 16">
            ...
            <div class="card my-3" style="width: 350px;">
                ...
                <div class="card-bottom text-end pr-2 pb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class='' style="width: 20px;" fill="#6d6d6d" viewBox="0 0 54 33">
