            ...
            <div class="about-me-context">
                <div class="card-body">
                    ...
                    <p class="card-text text-start">
                        ...
                        I found a simple tutorial in how to <span style="color: brown; font-size: 18px;">make a discord chat bot</span> from scratch. <br>
                        Out of curiosity, I started making one and before I knew, I was swallowed by this world of programming. <br><br>

                        I immediately signed up for a course for <span style="color: brown; font-size: 18px;">full stack web development</span>, and now the real journey begins!
                    </p>
                </div>
                
                <div class="card-body">
                    <h4 class="card-subtitle mb-2 text-muted text-start">Motivation</h4>
                    <p class="card-text text-start">
